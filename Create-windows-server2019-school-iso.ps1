...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/soerenderfor/configs/main/Remove_keypress_ISO.ps1" -OutFile "C:\Custom_ISO\Remove_keypress_ISO.ps1"
Set-Location C:\Custom_ISO
