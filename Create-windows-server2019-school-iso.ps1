...
# Copy content of the Source Windows ISO to the working folder and remove the read-only attribtues
...
# Now removing the prompt "Press any key to boot from CD/DVD" message
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/soerenderfor/configs/main/Remove_keypress_ISO.ps1" -OutFile "C:\Custom_ISO\Final\Remove_keypress_ISO.ps1"
Set-Location C:\Custom_ISO\Final
.\Remove_keypress_ISO.ps1 -SourceISOPath "C:\Custom_ISO\Final\windows_server2019_custom.iso" -UnattendedISOPath "C:\Custom_ISO\Final\windows_server2019_final.iso"
